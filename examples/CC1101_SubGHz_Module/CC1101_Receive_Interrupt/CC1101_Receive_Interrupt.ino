...
// hackbat CC1101 has the following connections:
// CS pin:    17
// GDO0 pin:  21
// RST pin:   unused
// GDO2 pin:  20 (optional)
CC1101 radio = new Module(17, 21, RADIOLIB_NC, 20);
...
void setup() {
  ...
  Serial.begin(9600);
  delay(9000);
  Serial.println("kihkhjgkhjghkjghkjghkjgjkgkjgkjgk");
